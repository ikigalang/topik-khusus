...
const Mahasiswa = (props) => (
  <tr className="text-center">
    ...
    <td>{props.konsentrasi}</td>
    <td>
      <Link to={"/edit-mahasiswa/" + props.mahasiswa._id + "/" + props.mahasiswa.nim}>
...
export default class DaftarDosen extends Component {
  ...
  listMahasiswa() {
    return this.state.dataMahasiswa.map((mahasiswa) => {
      return (
        <Mahasiswa mahasiswa={mahasiswa} konsentrasi={this.state.statikKonsentrasi[mahasiswa.konsentrasi]} deleteMahasiswa={this.deleteMahasiswa} key={mahasiswa.nim} />
      );
    });
  }
