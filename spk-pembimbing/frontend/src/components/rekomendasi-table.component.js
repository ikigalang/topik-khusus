    ...
    Axios.get(API_PEMBIMBING)
      ...
      .then(() => {
        ...
        this.state.pembimbing.forEach((pembimbing, n) => {
          ...
          let dummyPembimbing1 = this.state.pembimbing1;
          dummyPembimbing1.push(VA1);
          this.setState({
            pembimbing1: dummyPembimbing1,
          });
          ...
          let dummyPembimbing2 = this.state.pembimbing2;
          dummyPembimbing2.push(VA2);
          this.setState({
            pembimbing2: dummyPembimbing2,
          });
        });
      });
  }
  ...
  pembimbing1() {
    return this.state.pembimbing.map((dosen, n) => {
      return (
        <Dosen
          dosen={dosen}
          score={this.state.pembimbing1[n]}
  ...
  pembimbing2() {
    return this.state.pembimbing.map((dosen, n) => {
      return (
        <Dosen
          dosen={dosen}
          score={this.state.pembimbing2[n]}
          deleteDosen={this.deleteDosen}
          key={dosen._id}
        />
      );
  ...
  render() {
    return (
      <div className="container mt-4">
        <h3 className="text-center">HASIL REKOMENDASI DOSEN PEMBIMBING I</h3>
